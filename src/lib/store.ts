...
1. **حفظ التراث اللغوي الأيزيدي:** توثيق الكلمات بالخط الأيزيدي الأصلي (Ezidi Script) إلى جانب التمثيل الصوتي.
...
نرحب بجميع المساهمات اللغوية والأكاديمية لتطوير هذا المعجم القيم وتوثيق تراثه الغني.`,
    isPublished: true,
    showInNav: true,
    order: 1,
